  ...
  ui: function(params, cb) {
    ...
    if (FB._nativeInterface) {
        switch (params.method) {
            case 'auth.login':
                //FB._nativeInterface.login(params, cb, function(e) {alert('Cordova Facebook Connect plugin fail on login!' + e);});//cranberrygame
                FB._nativeInterface.login(params, cb, function(e) {console.log('Cordova Facebook Connect plugin fail on login!' + e);});//cranberrygame
                break;
            ...
            case 'permissions.oauth':
                ...
                break;
            case 'auth.logout':
                //FB._nativeInterface.logout(cb, function(e) {alert('Cordova Facebook Connect plugin fail on logout!');});//cranberrygame
                FB._nativeInterface.logout(cb, function(e) {console.log('Cordova Facebook Connect plugin fail on logout!'); cb(e);});//cranberrygame
                break;
            case 'auth.status':
                //FB._nativeInterface.getLoginStatus(cb, function(e) {alert('Cordova Facebook Connect plugin fail on auth.status!');});//cranberrygame
                FB._nativeInterface.getLoginStatus(cb, function(e) {console.log('Cordova Facebook Connect plugin fail on auth.status!');});//cranberrygame
                break;
            case 'login.status':
                //FB._nativeInterface.getLoginStatus(cb, function(e) {alert('Cordova Facebook Connect plugin fail on auth.status!');});//cranberrygame
                FB._nativeInterface.getLoginStatus(cb, function(e) {console.log('Cordova Facebook Connect plugin fail on auth.status!');});//cranberrygame
                break;
            case 'feed':
                //FB._nativeInterface.dialog(params, cb, function(e) {alert('Cordova Facebook Connect plugin fail on auth.status!');});//cranberrygame
                FB._nativeInterface.dialog(params, cb, function(e) {console.log('Cordova Facebook Connect plugin fail on auth.status!');});//cranberrygame
                break;
            case 'apprequests':
                //FB._nativeInterface.dialog(params, cb, function(e) {alert('Cordova Facebook Connect plugin fail on auth.status!');});//cranberrygame
                FB._nativeInterface.dialog(params, cb, function(e) {console.log('Cordova Facebook Connect plugin fail on auth.status!');});//cranberrygame
...
FB.provide('', {
  ...
  init: function(options) {
    ...
    if (FB._nativeInterface) {
      //FB._nativeInterface.init(FB._apiKey, function(e) {alert('Cordova Facebook Connect plugin fail on init!');});//cranberrygame
      FB._nativeInterface.init(FB._apiKey, function(e) {console.log('Cordova Facebook Connect plugin fail on init!');});//cranberrygame	  
    }
